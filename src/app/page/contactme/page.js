          ...
          <div className="sm:flex gap-[20px] mt-[50px] max-w-[1105px] w-full h-full">
            <div className="flex flex-col flex-1 xl:flex-row gap-[20px]">
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">Sousse, Tunisia</p>
                </div>
                <div>
                  <p className="text-[#666666]">Tunisia</p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">Phone: +216 52603967</p>
                </div>
                <div>
                  <p className="text-[#666666]">Mobile: +216 52603967</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-1 xl:flex-row gap-[20px]">
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">safwencherif4@gmail.com</p>
                </div>
                <div>
                  <p className="text-[#666666]">safwencherif2002@gmail.com</p>
                </div>
              </div>
